...
#
# Script generated by Vivado on Mon Aug 03 18:25:01 +1000 2026
...
#
# Usage        : xxv_ethernet_0.sh
#                xxv_ethernet_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xxv_ethernet_0.sh [-rerun]
#                xxv_ethernet_0.sh [-reset_run]
#                xxv_ethernet_0.sh [-clean]
#                xxv_ethernet_0.sh [-reset_log]
#                xxv_ethernet_0.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax  -L xxv_ethernet_v5_0_2"
...
# script info
echo -e "xxv_ethernet_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xxv_ethernet_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xxv_ethernet_0 xil_defaultlib.xxv_ethernet_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xxv_ethernet_0.wdb xsim.dir libdpi.so)
...
Usage: xxv_ethernet_0.sh [-step]\n\
Usage: xxv_ethernet_0.sh [-lib_map_path]\n\
Usage: xxv_ethernet_0.sh [-rerun]\n\
Usage: xxv_ethernet_0.sh [-reset_run]\n\
Usage: xxv_ethernet_0.sh [-clean]\n\
Usage: xxv_ethernet_0.sh [-reset_log]\n\
Usage: xxv_ethernet_0.sh [-keep_index]\n\
